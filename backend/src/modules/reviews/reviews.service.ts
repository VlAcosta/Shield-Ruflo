...
export const reviewInclude = {
  ...
  replies: { orderBy: { createdAt: 'desc' as const }, take: 1, select: { id: true, text: true, status: true, origin: true, generationMode: true, policyDecision: true, policyVersion: true, policyMetadata: true, providerState: true, providerPolicyViolation: true, lastReconciledAt: true, failedReason: true, publishedAt: true, createdAt: true, authorUserId: true } },
  assignments: {
