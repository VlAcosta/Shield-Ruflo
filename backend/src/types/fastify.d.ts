...
import type { ApiPrincipal } from '../modules/api-identity/api-identity.types.js';
...
declare module 'fastify' {
  interface FastifyInstance {
    ...
    authorizeApiScope: (permission: Permission) => (request: FastifyRequest, reply: FastifyReply) => Promise<void>;
  }
