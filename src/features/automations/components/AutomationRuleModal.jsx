...
import { AUTOMATION_ACTIONS, AUTOMATION_TRIGGERS } from '../model';

const PLATFORMS = ['Яндекс', '2GIS', 'Ozon', 'Отзовик', 'WB'];
const REASONS = ['качество', 'персонал', 'цена', 'доставка', 'сервис', 'ожидание', 'чистота', 'товар', 'описание', 'возврат'];
